...
//carregando o helper para validar se é o usuario admin
const { eAdmin } = require("../helpers/eAdmin");
// proteger as rotas como status de admin, basta colocar a variavel é {eAdmin} nas  routers antes da função
//definindo as rotas
